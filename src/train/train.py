...
def main(**kwargs):
    ...
    logger_inst = logger.get_logger("main", file_path=tensorboard_writer.path / "log.txt")
    ...
    for current_fold in full_config.training_config.train_folds:
        ...
        events = load_data.get_data(
            full_config.dataset_config, ignore_cache=kwargs["ignore_cache"], _save_cache=kwargs["save_cache"]
        )
        ...
        full_config.model_building_config.mean, full_config.model_building_config.std = (
